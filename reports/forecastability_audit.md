...
- PA-STFed horizon-decoder-wl1: recomputed WAPE/MAE/RMSE = {'wape': 27.998384475708008, 'mae': 0.32832086086273193, 'rmse': 0.7299471497535706}; max difference = 0.00000572 (PASS)
- PA-STFed horizon-specific-head: recomputed WAPE/MAE/RMSE = {'wape': 28.812002182006836, 'mae': 0.33786165714263916, 'rmse': 0.7184314131736755}; max difference = 0.00000000 (PASS)
...
| PA-STFed horizon-decoder-wl1 | prefix_h1 | 16.8171 | 0.197042 | 0.469155 |
| PA-STFed horizon-decoder-wl1 | prefix_h3 | 22.3015 | 0.261340 | 0.615786 |
| PA-STFed horizon-decoder-wl1 | prefix_h6 | 25.3027 | 0.296578 | 0.685251 |
| PA-STFed horizon-decoder-wl1 | prefix_h12 | 27.9984 | 0.328321 | 0.729947 |
| PA-STFed horizon-decoder-wl1 | step1 | 16.8171 | 0.197042 | 0.469155 |
| PA-STFed horizon-decoder-wl1 | step3 | 26.2665 | 0.307846 | 0.708994 |
| PA-STFed horizon-decoder-wl1 | step6 | 29.0054 | 0.340109 | 0.755823 |
| PA-STFed horizon-decoder-wl1 | step12 | 31.8358 | 0.373633 | 0.782380 |
| PA-STFed horizon-decoder-wl1 | overall_12step | 27.9984 | 0.328321 | 0.729947 |
| PA-STFed horizon-specific-head | prefix_h1 | 17.6433 | 0.206723 | 0.455648 |
| PA-STFed horizon-specific-head | prefix_h3 | 23.3683 | 0.273841 | 0.599374 |
| PA-STFed horizon-specific-head | prefix_h6 | 26.2109 | 0.307223 | 0.670158 |
| PA-STFed horizon-specific-head | prefix_h12 | 28.8120 | 0.337862 | 0.718431 |
| PA-STFed horizon-specific-head | step1 | 17.6433 | 0.206723 | 0.455648 |
| PA-STFed horizon-specific-head | step3 | 27.3338 | 0.320355 | 0.692502 |
| PA-STFed horizon-specific-head | step6 | 29.7092 | 0.348361 | 0.742976 |
| PA-STFed horizon-specific-head | step12 | 32.5491 | 0.382005 | 0.775643 |
| PA-STFed horizon-specific-head | overall_12step | 28.8120 | 0.337862 | 0.718431 |
...
| PA-STFed horizon-decoder-wl1 | prefix_h1 | 16.8171 | 5.7294 |
| PA-STFed horizon-decoder-wl1 | prefix_h3 | 22.3015 | 9.6565 |
| PA-STFed horizon-decoder-wl1 | prefix_h6 | 25.3027 | 11.3542 |
| PA-STFed horizon-decoder-wl1 | prefix_h12 | 27.9984 | 12.3120 |
| PA-STFed horizon-decoder-wl1 | step1 | 16.8171 | 5.7294 |
| PA-STFed horizon-decoder-wl1 | step3 | 26.2665 | 12.4339 |
| PA-STFed horizon-decoder-wl1 | step6 | 29.0054 | 12.9709 |
| PA-STFed horizon-decoder-wl1 | step12 | 31.8358 | 13.3704 |
| PA-STFed horizon-decoder-wl1 | overall_12step | 27.9984 | 12.3120 |
| PA-STFed horizon-specific-head | prefix_h1 | 17.6433 | 4.9598 |
| PA-STFed horizon-specific-head | prefix_h3 | 23.3683 | 7.1414 |
| PA-STFed horizon-specific-head | prefix_h6 | 26.2109 | 8.7239 |
| PA-STFed horizon-specific-head | prefix_h12 | 28.8120 | 10.2264 |
| PA-STFed horizon-specific-head | step1 | 17.6433 | 4.9598 |
| PA-STFed horizon-specific-head | step3 | 27.3338 | 8.9808 |
| PA-STFed horizon-specific-head | step6 | 29.7092 | 10.5434 |
| PA-STFed horizon-specific-head | step12 | 32.5491 | 12.3856 |
| PA-STFed horizon-specific-head | overall_12step | 28.8120 | 10.2264 |
...
| decoder - horizon_specific_head_minus_horizon_decoder | step1 | -0.1075 | -0.001260 | -0.003709 | -0.4301 |
| decoder - horizon_specific_head_minus_horizon_decoder | step3 | 0.1985 | 0.002326 | -0.000438 | -0.2699 |
| decoder - horizon_specific_head_minus_horizon_decoder | step6 | 0.0347 | 0.000407 | 0.000185 | -0.0481 |
| decoder - horizon_specific_head_minus_horizon_decoder | step12 | 0.0124 | 0.000145 | 0.001132 | 0.6358 |
| decoder - horizon_specific_head_minus_horizon_decoder | overall_12step | 0.0421 | 0.000494 | 0.000347 | 0.1082 |
| decoder - horizon_specific_head_minus_gwn | step1 | 0.2539 | 0.002975 | -0.001673 | -0.0484 |
| decoder - horizon_specific_head_minus_gwn | step3 | -0.0218 | -0.000256 | 0.000359 | 0.6654 |
| decoder - horizon_specific_head_minus_gwn | step6 | -0.3553 | -0.004166 | 0.002725 | 1.1768 |
| decoder - horizon_specific_head_minus_gwn | step12 | -0.3495 | -0.004102 | 0.010571 | 2.6704 |
| decoder - horizon_specific_head_minus_gwn | overall_12step | -0.1934 | -0.002268 | 0.005426 | 1.4588 |

## WAPE-aligned Horizon Decoder Differences

Differences are WL1 minus the named comparison; negative values favor WL1.

| Comparison | Horizon | dWAPE | dMAE | dRMSE | dFeeder WAPE |
|---|---:|---:|---:|---:|---:|
| wl1_minus_horizon_decoder | step1 | -0.9338 | -0.010941 | 0.009798 | 0.3395 |
| wl1_minus_horizon_decoder | step3 | -0.8688 | -0.010182 | 0.016054 | 3.1832 |
| wl1_minus_horizon_decoder | step6 | -0.6691 | -0.007846 | 0.013031 | 2.3794 |
| wl1_minus_horizon_decoder | step12 | -0.7009 | -0.008226 | 0.007870 | 1.6206 |
| wl1_minus_horizon_decoder | overall_12step | -0.7715 | -0.009047 | 0.011863 | 2.1937 |
| wl1_minus_gwn | step1 | -0.5723 | -0.006706 | 0.011834 | 0.7211 |
| wl1_minus_gwn | step3 | -1.0891 | -0.012764 | 0.016851 | 4.1184 |
| wl1_minus_gwn | step6 | -1.0591 | -0.012418 | 0.015571 | 3.6044 |
| wl1_minus_gwn | step12 | -1.0628 | -0.012474 | 0.017308 | 3.6552 |
| wl1_minus_gwn | overall_12step | -1.0070 | -0.011809 | 0.016941 | 3.5443 |
| wl1_minus_residual_scale | step1 | -0.9649 | -0.011305 | 0.006087 | 0.7399 |
| wl1_minus_residual_scale | step3 | -1.0596 | -0.012419 | 0.019488 | 3.8038 |
| wl1_minus_residual_scale | step6 | -0.8432 | -0.009888 | 0.019148 | 3.5013 |
| wl1_minus_residual_scale | step12 | -0.8481 | -0.009954 | 0.014511 | 2.8163 |
| wl1_minus_residual_scale | overall_12step | -0.9467 | -0.011101 | 0.017601 | 3.2774 |

## Paired Validation WAPE Block Differences

Block differences use the existing validation_wape_blocks with identical origins and 96-window blocks. Values are descriptive only; no significance claim is made.

| Comparison | Blocks | Mean dWAPE | P10 | P25 | Median | P75 | P90 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| wl1_minus_horizon_decoder | 37 | -0.7965 | -1.3084 | -0.9298 | -0.6953 | -0.5943 | -0.4461 |
| wl1_minus_gwn | 37 | -1.0799 | -1.9858 | -1.6230 | -1.0763 | -0.7735 | -0.2897 |
...
- PA-STFed horizon-decoder-wl1: {'min': 2.2184901237487793, 'p10': 12.098637580871582, 'p25': 23.806976318359375, 'median': 27.778032302856445, 'p75': 39.707740783691406, 'p90': 45.93357849121094, 'max': 57.657657623291016}; counts={'lt10': 8, 'lt20': 13, 'lt30': 50, 'ge40': 21}
- PA-STFed horizon-specific-head: {'min': 2.484064817428589, 'p10': 11.932197570800781, 'p25': 24.73508071899414, 'median': 28.849849700927734, 'p75': 40.53908920288086, 'p90': 46.609291076660156, 'max': 54.89970016479492}; counts={'lt10': 5, 'lt20': 12, 'lt30': 50, 'ge40': 27}
...
- PA-STFed horizon-decoder-wl1: {'train_cv': 0.3817240163462417, 'lag96_autocorr': -0.6847412552197436, 'lag672_autocorr': -0.7080680631171491, 'mean_shift': -0.36118779154826147}
- PA-STFed horizon-specific-head: {'train_cv': 0.445252180220174, 'lag96_autocorr': -0.636646095116666, 'lag672_autocorr': -0.6581382102580957, 'mean_shift': -0.3183346107479714}
